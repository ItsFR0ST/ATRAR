...
module.exports.run = async (client, message, args) => {
  ...
  let embed = new Discord.MessageEmbed()
    ...
    .addField("Staff Commands", "`announcement` `warn` `nick` `mute` `unmute` `ban` `softban` `unban` `clear` ")
    ...
    .setColor("RANDOM")
    .setTimestamp()
    .setFooter(`Version: 1.65, Thx for buying the premium version of the bot`, botFetch.displayAvatarURL())
